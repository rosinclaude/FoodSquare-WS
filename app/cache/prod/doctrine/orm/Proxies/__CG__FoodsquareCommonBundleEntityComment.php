 ...
 */
class Comment extends \Foodsquare\CommonBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'thread', 'commenter', '' . "\0" . 'Foodsquare\\CommonBundle\\Entity\\Comment' . "\0" . 'comment', '' . "\0" . 'Foodsquare\\CommonBundle\\Entity\\Comment' . "\0" . 'date');
        }
