 ...
 */
class Photo extends \Foodsquare\CommonBundle\Entity\Photo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Foodsquare\\CommonBundle\\Entity\\Photo' . "\0" . 'id', '' . "\0" . 'Foodsquare\\CommonBundle\\Entity\\Photo' . "\0" . 'url', '' . "\0" . 'Foodsquare\\CommonBundle\\Entity\\Photo' . "\0" . 'miniature', '' . "\0" . 'Foodsquare\\CommonBundle\\Entity\\Photo' . "\0" . 'titre', '' . "\0" . 'Foodsquare\\CommonBundle\\Entity\\Photo' . "\0" . 'date', 'owner');
        }
