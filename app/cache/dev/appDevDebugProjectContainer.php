...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'foodsquare', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Foodsquare/CommonBundle/Entity'))), 'Foodsquare\\CommonBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('FoodsquareCommonBundle' => 'Foodsquare\\CommonBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3d47a42f62729244be29fee2d4e69b2f3aa69aa9a1906fff00903537357cf910');
    ...
    protected function getNelmioApiDoc_Formatter_HtmlFormatterService()
    {
        ...
        $instance->setApiName('FoodSquare');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Foodsquare/CommonBundle/Resources/views'), 'FoodsquareCommon');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fc91c05d5441038ff72a89ed1d7f38627');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Foodsquare/CommonBundle/Resources/config/validation.yml')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FoodsquareCommonBundle' => 'Foodsquare\\CommonBundle\\FoodsquareCommonBundle',
            ...
            'locale' => 'en',
            'secret' => 'fc91c05d5441038ff72a89ed1d7f38627',
            'debug_toolbar' => true,
            'debug_redirects' => false,
            'use_assetic_controller' => true,
            'google_api_key' => 'AIzaSyDnPwB1DFZmyLxMycXFuENozNzt1TBoONE',
            ...
            'kernel.secret' => 'fc91c05d5441038ff72a89ed1d7f38627',
            ...
            'nelmio_api_doc.api_name' => 'FoodSquare',
